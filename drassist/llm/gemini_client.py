...
class GeminiClient:
    ...
    def _initialize_vertex_ai(self) -> None:
        ...
        if self._credentials is None or self._project_id is None:
            ...
            logger.info(f"Vertex AI initialized for project: {self._project_id}")
        ...
        if self._client is None:
            with self._client_lock:
                ...
                if self._client is None:
                    ...
                    logger.info(f"Gemini client created for model: {self.model_name}")
    ...
    def generate_structured_content(
        ...
        **generation_config_overrides,
        ...
        try:
            ...
            response = self._generate_content(prompt, extra_config, **generation_config_overrides)
