"""Configuration helpers for BOP/PFMEA parsing and application settings."""
...
def get_log_level() -> int:
    ...
    return getattr(logging, settings.log_level.upper(), logging.WARNING)
...
def configure_backend_logging() -> None:
    ...
    configure_logging(level=log_level, structured=True)
