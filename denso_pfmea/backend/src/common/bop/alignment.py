...
def compute_column_alignment(
    ...
    """Return mapping of updated column keys to original column keys for stable alignment."""
    ...
    for block, new_group in updated_catalog.groupby("block"):
        ...
        # Fallback: attempt to align remaining elements from the tail when labels are similar.
        from difflib import (
            SequenceMatcher,
